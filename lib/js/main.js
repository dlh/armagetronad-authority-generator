...
function focusOnFirstAttributedElement(rootElement) {
    var e = rootElement.querySelector("[data-focus-after-scroll]:first-child");
    if (e)
        e.focus();
}
...
var app = new Vue({
    ...
    ready: function() {
        focusOnFirstAttributedElement(this.$el);
    ...
    methods: {
        ...
        moveToAnchor: function(anchor) {
            ...
            animate.scrollTo(el.offsetTop, 500, function() {
                focusOnFirstAttributedElement(el)
            });
        },
